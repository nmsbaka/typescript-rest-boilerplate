...
const helloRequest: request.RequestAPI<
  request.Request,
  request.CoreOptions,
...
describe('Hello Controller Tests', () => {
  ...
  describe('The Rest Server', () => {
    it('should provide a catalog containing the exposed paths', () => {
      ...
      expect(Server.getHttpMethods('/hello/:name')).to.have.members([
        HttpMethod.GET,
      ])
      expect(Server.getHttpMethods('/hello-objects/:name')).to.have.members([
        HttpMethod.GET,
      ])
    })
  })
