...
export class HelloObjectController {
  ...
  public sayArrayObjectHello(): Array<SimpleHello> {
    return [new SimpleHello('1'), new SimpleHello('2')]
  }
  ...
  @Path(':name/types')
  @GET
  public saySimpleHelloTypes(
    @PathParam('name') name: string,
  ): Array<SimpleHelloType> {
    return [new SimpleHello(name + '1'), new SimpleHello(name + '2')]
  }
  ...
  @GET
  public saySimpleHelloType(
    @PathParam('name') name: string,
    @PathParam('typeName') typeName: string,
  ): SimpleHelloType {
  ...
  @Path(':name/promises')
  @GET
  public sayArrayObjectPromiseHello(
    @PathParam('name') name: string,
  ): Promise<Array<SimpleHello>> {
    return new Promise((resolve, reject) => {
      resolve([new SimpleHello(name + '1'), new SimpleHello(name + '2')])
    })
  }
  ...
  @GET
  public sayObjectPromiseHello(
    @PathParam('name') name: string,
    @PathParam('promiseName') promiseName: string,
  ): Promise<SimpleHello> {
    return new Promise((resolve, reject) => {
